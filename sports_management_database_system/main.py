...
def main():
    st.image("https://institute.careerguide.com/wp-content/uploads/2020/07/sports-marketing-1.jpg")
    st.markdown("<h1 style='text-align:center';>Sports Management Database System</h1>", unsafe_allow_html=True)

    option = ["CRUD Operations","SQL Editor"]
    choice1 = st.sidebar.selectbox("Select one of the option", option)

    if choice1 == "CRUD Operations":
        ...
        if choice == "Sports":
            ...
            choice = st.sidebar.selectbox("CRUD Operations", crud)
    ...
    st.sidebar.write("Divya M")
    st.sidebar.write("PES1UG21CS810")
    st.sidebar.write("5th sem 'D' section")
