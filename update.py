...
def update_sport():
    ...
    if selected_result:
        ...
        if st.button("Update Sports"):
            ...
            st.success("Old values -----> Sports Id = {}, Sports Name = {}, Category = {}".format(selected_result[0][0],selected_result[0][1],selected_result[0][2]))
            st.success("Updated -----> Sports Id = {}, Sports Name = {}, Category = {}".format(new_sport_id, new_sport_name, new_category))
...
def update_coach():
    ...
    if selected_result:
        ...
        if st.button("Update Coach"):
            edit_coach(new_coach_id, new_coach_name, new_coach_phno, new_coach_address, new_coach_specialization, Cid, Cname, Ph_no, Address, Specialized_in)
            st.success("Successfully updated values of tuple")
            st.success("Old values -----> Coach Id = {}, Coach Name = {}, Phone no = {}, Address = {}, Specialized_in = {}".format(selected_result[0][0], selected_result[0][1], selected_result[0][2], selected_result[0][3], selected_result[0][4]))
            st.success("Updated values -----> Coach Id = {}, Coach Name = {}, Phone no = {}, Address = {}, Specialized_in = {}".format( new_coach_id, new_coach_name, new_coach_phno, new_coach_address, new_coach_specialization))
...
def update_league():
    ...
    if selected_result:
        ...
        if st.button("Update League"):
            ...
            st.success("Successfully updated values of tuple")
            st.success("Old values -----> League Id = {}, League Name = {}".format(selected_result[0][0],selected_result[0][1]))
...
def update_matches():
    ...
    if selected_result:
        ...
        if st.button("Update Match"):
            edit_match(new_match_id, new_team1, new_team2, new_refree, new_location, new_lid, Mid, Team1, Team2, Refree, Location, Lid)
            st.success("Successfully updated values of tuple")
            st.success("Old values -----> Match Id = {}, Team1 = {}, Team2 = {}, Refree = {}, Location = {}, League Id = {}".format(selected_result[0][0], selected_result[0][1], selected_result[0][2], selected_result[0][3], selected_result[0][4], selected_result[0][5]))
            st.success("Updated values -----> Match Id = {}, Team1 = {}, Team2 = {}, Refree = {}, Location = {}, League Id  = {}".format( new_match_id, new_team1, new_team2, new_refree, new_location, new_lid))
...
def update_teams():
    ...
    df = pd.DataFrame(result,columns = ["Team Id", "Team Name", "Captain", "No of players", "Sports Id", "Coach Id", "Match Id", "League Id"])
    ...
    if selected_result:
        ...
        if st.button("Update Teams"):
            edit_team(new_Tid , new_Tname, new_captain, new_no_of_players, new_sid, new_cid, new_mid, new_lid, Tid, Tname, Captain, No_of_players, Sid, Cid, Mid, Lid)
            st.success("Successfully updated values of tuple")
            st.success("Old values -----> Team Id = {}, Team Name = {}, Captain = {}, No of players = {}, Sports Id = {}, Coach Id = {}, Match Id = {}, League Id = {}".format(selected_result[0][0],selected_result[0][1],selected_result[0][2],selected_result[0][3],selected_result[0][4],selected_result[0][5],selected_result[0][6],selected_result[0][7]))
            st.success("Updated -----> Team Id = {}, Team Name = {}, Captain = {}, No of players = {}, Sports Id = {}, Coach Id = {}, Match Id = {}, League Id = {}".format(new_Tid , new_Tname, new_captain, new_no_of_players, new_sid, new_cid, new_mid, new_lid))

    result2 = view_all_teams()
    df2 = pd.DataFrame(result2, columns=["Team Id", "Team Name", "Captain", "No of players", "Sports Id", "Coach Id", "Match Id", "League Id"])
...
def update_players():
    ...
    df = pd.DataFrame(result,columns = ["Player Id", "Firstname", "Lastname", "Date of birth", "Age", "Phone no", "Address", "Coach Id", "Team Id"])
    ...
    if selected_result:
        ...
        if st.button("Update Player"):
            edit_player(new_Pid, new_Fname, new_Lname, new_Dob, new_Age, new_Ph_no, new_Address, new_cid, new_tid, Pid, Fname, Lname, Dob, Age, Ph_no, Address, Cid, Tid)
            st.success("Successfully updated values of tuple")
            st.success("Old values -----> Player Id = {}, Firstname = {}, Lastname = {}, Date of birth = {}, Age = {}, Phone no = {}, Address = {}, Coach Id = {}, Team Id = {}".format(selected_result[0][0],selected_result[0][1],selected_result[0][2],selected_result[0][3],selected_result[0][4],selected_result[0][5],selected_result[0][6],selected_result[0][7],selected_result[0][8]))
            st.success("Updated -----> Player Id = {}, Firstname = {}, Lastname = {}, Date of birth = {}, Age = {}, Phone no = {}, Address = {}, Coach Id = {}, Team Id = {}".format(new_Pid, new_Fname, new_Lname, new_Dob, new_Age, new_Ph_no, new_Address, new_cid, new_tid))

    result2 = view_all_players()
    df2 = pd.DataFrame(result2, columns = ["Player Id", "Firstname", "Lastname", "Date of birth", "Age", "Phone no", "Address", "Coach Id", "Team Id"])
